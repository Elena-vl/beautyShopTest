				...
				<div class="col-md-9">
					...
					<div class="row">
						...
						global $product;
							...
							<article class="product light" style ="min-height: 395px; max-height: 395px;">
								<figure class="figure-hover-overlay fill-viewport align-items-center">
									<a href="#"	class="figure-href"></a>
									<?php 
										$post_thumbnail_id = $product->get_image_id();
//										$thumbnail_size = apply_filters( 'woocommerce_gallery_thumbnail_size', array( $gallery_thumbnail['width'], $gallery_thumbnail['height'] ) );
										$thumbnail_src = wp_get_attachment_image_src( $post_thumbnail_id, 'full');
										echo '<img src="' . esc_url( $thumbnail_src[0] ) . '" class="img-responsive" alt="" style ="min-height: 263px;"/>';
									?>
								</figure>
