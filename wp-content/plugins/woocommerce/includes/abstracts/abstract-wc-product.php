...
class WC_Product extends WC_Abstract_Legacy_Product {
	...
	*/
	...
	public function add_to_cart_text() {
		...
		return apply_filters( 'woocommerce_product_add_to_cart_text', __( 'Читать дальше', 'woocommerce' ), $this );
	}
	...
	public function add_to_cart_description() {
		...
		return apply_filters( 'woocommerce_product_add_to_cart_description', sprintf( __( 'Подробнее о &ldquo;%s&rdquo;', 'woocommerce' ), $this->get_name() ), $this );
	}
